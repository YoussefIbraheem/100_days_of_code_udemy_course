...
def search():
    ...
    try:
        ...
        if not located_data:
            messagebox.showwarning("Not Found", "No website data found!")
            return

        messagebox.showinfo(
            f"{keyword}",
            f"Email/Username: {located_data['email_username']}\nPassword:{located_data['password']}",
        )
...
search_btn = tk.Button(
    text="Search", width=14, font=("Arial", 8, "normal"), command=search
)
